...
(function() {
  ...
  cPreProcessor = function(source, filename, indent) {
    var ad, an, ba, buf, c, c2, cl, d, def, defFull, define, di, directives, dm, ecran, error, f, i, i2, ifState, ifactive, include, isw, l, line, n, nfound, os, out, q, replace, s, sd, sl, token, undef, warn, word, wr;
    if (indent == null) {
      indent = "";
    }
