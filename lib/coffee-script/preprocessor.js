...
(function() {
  ...
  cPreProcessor = function(source, filename, indent) {
    var ad, an, ba, buf, c, cl, d, def, defFull, define, di, directives, dm, ecran, error, f, i, i2, ifactive, ifpassed, iftrue, include, l, line, n, nfound, os, out, q, replace, s, sd, sl, token, undef, warn, word, wr;
    if (indent == null) {
      indent = "";
    }
