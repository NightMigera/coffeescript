...
(function() {
  var cPreProcessor, fs, gn, gw, makros, path, startWatcher, subscribeChange, timers, unsubscribeChange, wait, watchers,
  ...
  startWatcher = function(path) {
    fs.exists(path, function(e) {
      ...
      fileWatcher = fs.watch(path, function(action, pathChanged) {
