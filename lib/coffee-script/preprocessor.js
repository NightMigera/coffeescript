...
(function() {
  ...
  cPreProcessor = function(source, filename, indent) {
    var ad, an, ba, buf, c, cl, d, def, define, di, directives, dm, ecran, error, f, i, i2, ifactive, ifpassed, iftrue, include, l, line, makroReplaceFunc, n, nfound, os, out, q, replace, s, sd, sl, token, undef, warn, word, wr;
    if (indent == null) {
      indent = "";
    }
