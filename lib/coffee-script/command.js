...
(function() {
  var BANNER, CoffeeScript, EventEmitter, SWITCHES, compileJoin, compileOptions, compilePath, compileScript, compileStdio, exec, findDirectoryIndex, forkNode, fs, helpers, hidden, joinTimeout, mkdirp, notSources, optionParser, optparse, opts, outputPath, parseOptions, path, pp, printLine, printTokens, printWarn, removeSource, removeSourceDir, silentUnlink, sourceCode, sources, spawn, timeLog, usage, useWinPathSep, version, wait, watch, watchDir, watchedDirs, writeJs, _ref,
  ...
  compilePath = function(source, topLevel, base) {
    var code, err, file, files, stats, wr, _i, _len, _results;
    ...
    if (stats.isDirectory()) {
      ...
      return compileScript(source, code.toString(), base, wr);
    } else {
  ...
  compileScript = function(file, input, base, watcher) {
    ...
    compile = function(force) {
      ...
      return compileTimeout = wait(25, function() {
        return fs.stat(source, function(err, stats) {
          ...
          if (force !== true && prevStats && stats.size === prevStats.size && stats.mtime.getTime() === prevStats.mtime.getTime()) {
            return rewatch();
          }
          prevStats = stats;
